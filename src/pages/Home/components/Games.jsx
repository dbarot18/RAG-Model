...
export default function Games() {
  ...
  return (
    <div id="games" className="relative overflow-hidden bg-white py-24">
      <div className="flex flex-col items-center mx-auto max-w-7xl px-8 sm:px-6 md:px-16 lg:px-8">
        <h1 className="text-4xl sm:text-6xl font-bold text-center text-gray-900 mb-10 tracking-wider">
          {text}
        </h1>

        <div className="gamesContainer w-full rounded-3xl p-6 grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 bg-gradient-to-br from-blue-700 to-purple-800">
          {games.map((game, idx) => (
            <div
              key={idx}
